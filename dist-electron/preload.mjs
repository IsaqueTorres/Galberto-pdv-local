...
electron.contextBridge.exposeInMainWorld("api", {
  ...
  atualizarLayoutPrinter: (id, dados) => electron.ipcRenderer.invoke("printer:atualizar-layout", id, dados),
  atualizarPersonalizacaoPrinter: (id, receiptSettingsJson) => electron.ipcRenderer.invoke("printer:atualizar-personalizacao", id, receiptSettingsJson),
  testPrint: (printerId) => electron.ipcRenderer.invoke("printer:test-print", printerId),
  reprintSaleReceipt: (saleId) => electron.ipcRenderer.invoke("printer:reprint-sale-receipt", saleId),
...
electron.contextBridge.exposeInMainWorld("electron", {
  ...
  fiscal: {
    ...
    getContext: (storeId) => electron.ipcRenderer.invoke("fiscal:get-context", storeId),
    validateReadiness: (storeId) => electron.ipcRenderer.invoke("fiscal:validate-readiness", storeId),
    getActiveStore: () => electron.ipcRenderer.invoke("fiscal:get-active-store"),
    saveActiveStore: (input) => electron.ipcRenderer.invoke("fiscal:save-active-store", input),
