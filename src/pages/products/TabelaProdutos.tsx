    ...
    return (
        ...
        <section className="animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    <h2 className="text-2xl font-bold text-gray-800 dark:text-white tracking-tight">Gestão de Produtos</h2>
                    <p className="text-sm text-gray-500 dark:text-zinc-400">Pesquise, gerencie e cadastre Produtos do seu estoque.</p>
                </div>
                ...
                <div className="flex justify-between items-center">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-5 py-2 bg-slate-800 hover:bg-slate-700 text-white text-sm font-bold rounded-xl shadow-lg transition-all active:scale-95"
            ...
            < div className="p-4 border-b border-gray-200" >
                <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-zinc-800 text-white border border-gray-200 dark:border-zinc-700 rounded-xl 
                        text-sm outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all"
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-gray-50/50 dark:bg-zinc-800/50 border-b border-gray-100 dark:border-zinc-800">
                                ...
                                <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-gray-400">Nome do Produto</th>
                                <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-gray-400">Código de Barras</th>
                                <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-gray-400">Preço</th>
                                <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-gray-400">Estoque</th>
                                <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-gray-400">Status (ativo/inativo)</th>
                                <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-gray-400">Ações</th>
                            </tr>
                        </thead>
                        ...
                        <tbody className="divide-y divide-gray-50 dark:divide-zinc-800">
                            {produtos.map((p) => (
                                ...
                                >
                                    ...
                                    <td className="text-sm font-bold text-gray-800 dark:text-gray-200">{p.nome}</td>
                                    <td className="text-sm font-bold text-gray-800 dark:text-gray-200">{p.codigo_barras}</td>
                                    <td className="text-sm font-bold text-gray-800 dark:text-gray-200">R$ {p.preco_venda.toFixed(2)}</td>
                                    <td className="text-sm font-bold text-gray-800 dark:text-gray-200">{p.estoque_atual}</td>
                                    <td className="text-sm font-bold text-gray-800 dark:text-gray-200">
                                        <span
